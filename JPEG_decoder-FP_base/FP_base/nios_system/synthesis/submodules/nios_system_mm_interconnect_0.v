...
module nios_system_mm_interconnect_0 (
	...
	wire  [107:0] router_001_src_data;                                                                                 // router_001:src_data -> nios2_qsys_0_data_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                                                // nios2_qsys_0_data_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [6:0] router_001_src_channel;                                                                              // router_001:src_channel -> nios2_qsys_0_data_master_limiter:cmd_sink_channel
	...
	wire  [107:0] nios2_qsys_0_data_master_limiter_cmd_src_data;                                                       // nios2_qsys_0_data_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [6:0] nios2_qsys_0_data_master_limiter_cmd_src_channel;                                                    // nios2_qsys_0_data_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [107:0] rsp_mux_001_src_data;                                                                                // rsp_mux_001:src_data -> nios2_qsys_0_data_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                                               // nios2_qsys_0_data_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [6:0] rsp_mux_001_src_channel;                                                                             // rsp_mux_001:src_channel -> nios2_qsys_0_data_master_limiter:rsp_sink_channel
	...
	wire  [107:0] router_002_src_data;                                                                                 // router_002:src_data -> nios2_qsys_0_instruction_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                                                // nios2_qsys_0_instruction_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [6:0] router_002_src_channel;                                                                              // router_002:src_channel -> nios2_qsys_0_instruction_master_limiter:cmd_sink_channel
	...
	wire  [107:0] nios2_qsys_0_instruction_master_limiter_cmd_src_data;                                                // nios2_qsys_0_instruction_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	...
	wire    [6:0] nios2_qsys_0_instruction_master_limiter_cmd_src_channel;                                             // nios2_qsys_0_instruction_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [107:0] rsp_mux_002_src_data;                                                                                // rsp_mux_002:src_data -> nios2_qsys_0_instruction_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                                                               // nios2_qsys_0_instruction_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [6:0] rsp_mux_002_src_channel;                                                                             // rsp_mux_002:src_channel -> nios2_qsys_0_instruction_master_limiter:rsp_sink_channel
	...
	wire    [6:0] nios2_qsys_0_data_master_limiter_cmd_valid_data;                                                     // nios2_qsys_0_data_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire    [6:0] nios2_qsys_0_instruction_master_limiter_cmd_valid_data;                                              // nios2_qsys_0_instruction_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
